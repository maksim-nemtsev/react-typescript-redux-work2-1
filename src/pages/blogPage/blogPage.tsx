...
import blog3_1 from "../../assets/img/blog3=1.jpg";
import blog_author from "../../assets/img/blog-author.jpg";
...
export const BlogPage = (props: Props) => {
  const { idBlog } = useParams<Params>();

  const title = idBlog.split("-");
  const history = useHistory();
  ...
  return (
    <div className="App-wrapper">
      ...
      <div className="blog-container">
        <div className="blog-page d-flex">
          <img
            onClick={backHandler}
            className="card-page__svg"
            src={arrowBack}
        ...
        <div className="blog__content">
          <Row className="p-2">
            <Col sm="6">
              <img src={blog3_1} alt="blog_image" />
            </Col>
            <Col sm="6">
              <h4 className="blog_title p-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                suspendisse
              </h4>
              <p className="blog_subtitle p-2">
              ...
              <div className="blog_author d-flex">
                ...
                <div className="author_content">
                  <h6 className="author_title">Sean Gavin</h6>
                  <span className="author_subtitle">
                    Manager | Posted on 5/31/2021
                  </span>
                </div>
              </div>
            </Col>
